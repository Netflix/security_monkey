...
mod = Blueprint('auditorsettings', __name__)
api = Api(mod)
...
api.add_resource(AuditorSettingsGet, '/auditorsettings')
api.add_resource(AuditorSettingsPut, '/auditorsettings/<int:as_id>')
