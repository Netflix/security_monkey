...
api.add_resource(RevisionList, '/revisions')
api.add_resource(RevisionGet, '/revisions/<int:revision_id>')
api.add_resource(RevisionCommentPost, '/revisions/<int:revision_id>/comments')
api.add_resource(RevisionCommentGet, '/revisions/<int:revision_id>/comments/<int:comment_id>')
api.add_resource(RevisionCommentDelete, '/revisions/<int:revision_id>/comments/<int:comment_id>')
